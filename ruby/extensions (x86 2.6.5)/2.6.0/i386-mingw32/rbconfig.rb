...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--prefix=/mingw32' '--build=i686-w64-mingw32' '--host=i686-w64-mingw32' '--target=i686-w64-mingw32' '--without-ext=pty,syslog' 'build_alias=i686-w64-mingw32' 'host_alias=i686-w64-mingw32' 'target_alias=i686-w64-mingw32' 'CFLAGS=-O3 -fno-fast-math' 'LDFLAGS=-pipe -s' 'CPPFLAGS=-D__USE_MINGW_ANSI_STDIO=1 -DFD_SETSIZE=2048' 'CXXFLAGS=-march=i686 -mtune=generic -O2 -pipe'"
  ...
  CONFIG["CFLAGS"] = "-O3 -fno-fast-math"
