...
module RbConfig
  RUBY_VERSION.start_with?("2.5.") or
    raise "ruby lib version (2.5.6) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["configure_args"] = " '--disable-install-doc' '--enable-install-static-library' '--enable-dln'"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc.exe (Rev1, Built by MSYS2 project) 7.4.0\nCopyright (C) 2017 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.5.6"
  CONFIG["HAVE_GIT"] = "yes"
  CONFIG["GIT"] = "git"
